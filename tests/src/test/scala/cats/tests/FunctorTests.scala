...
class FunctorTest extends CatsSuite {
  ...
  val optionXorFunctor: Functor[OptionXor] = Functor[Option].compose[Xor[String, ?]]
  ...
  checkAll("Option composeWithFunctor Xor",
           FunctorTests(optionComposeWithFunctorXor).functor[Int, Int, Int])
  checkAll("Functor[Option composeWithFunctor Xor]",
           SerializableTests.serializable(optionComposeWithFunctorXor))
  ...
  checkAll("Option composeWithContravariant Show",
           ContravariantTests(optionShowContravariant).contravariant[Int, Int, Int])
  checkAll("Contravariant[Option composeWithContravariant Show]",
           SerializableTests.serializable(optionShowContravariant))
