...
class BitraverseTest extends CatsSuite {
  ...
  val xorComposeTuple2: Bitraverse[XorTuple2] = Bitraverse[Xor].compose[Tuple2]

  checkAll(
    "Xor compose Tuple2",
    BitraverseTests(xorComposeTuple2).bitraverse[Option, Int, Int, Int, String, String, String])
